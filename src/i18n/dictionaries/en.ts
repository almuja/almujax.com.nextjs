const en = {
  ...
  structuredData: {
    description:
      "Mujahid Siyam, known as Mawja (itsmawja), is a Sudanese software engineer, network engineer, AI cloud architect, data scientist, system administrator (Linux and Windows), rapper, music producer, and content creator born in Sudan and based in Paris, France. He started making music at age 16, forming bands and performing before transitioning into software engineering, cloud architecture, and AI. He builds production software systems with Rust, TypeScript, and Python, manages infrastructure with Terraform, Ansible, Docker, and Kubernetes on AWS, and administers Linux and Windows servers. In 2022 he returned to music, releasing his debut EP KAKASHI under the name Mawja. His next EP Rockstar is scheduled for August 2026. His music spans Arabic, Middle Eastern, and African rap and hip-hop, blending Sudanese roots with European life. He is the founder of Zaroxi Studio, a GPU-accelerated IDE written in Rust, and the creator of MujaOS. He bridges engineering and music from Paris, France. Contact: hello@itsmawja.com.",
    websiteDescription:
      "Official website of Mujahid Siyam (Mawja / itsmawja) — Sudanese software engineer, network engineer, AI cloud architect, data scientist, system administrator, rapper, and music artist born in Sudan, based in Paris, France. Started music at 16, built a career in engineering and cloud infrastructure, returned to music in 2022 with KAKASHI EP. Rockstar EP coming August 2026. Founder of Zaroxi Studio (zaroxi.com). Projects, technical writing, and original Arabic, Middle Eastern, and African rap.",
  },
  seo: {
    keywords: [
      ...
      "Rust Engineer", "NixOS Developer", "DevSecOps Engineer", "DevOps Engineer",
      "Full-stack Engineer", "AI Engineer", "Backend Developer",
