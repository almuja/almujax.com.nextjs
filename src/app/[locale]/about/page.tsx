...
const socialLinks = [
  ...
  {
    n: "SC",
    h: "https://snapchat.com/add/almujax",
    i: (c: string) => (
      <svg className={c} viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    n: "AM",
    h: "https://music.apple.com/fr/artist/almuja/6800033494",
    i: (c: string) => (
      <svg className={c} viewBox="0 0 24 24" fill="currentColor">
