...
const SIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-2-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z"/></svg>
);

const AIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor"><path d="M9 18V5l12-2v13c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4c.8 0 1.5.2 2 .6V3l-8 1.3v10.7c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4c.8 0 1.5.2 2 .6z"/></svg>
);
...
const contactLinks = [
  { label: "GitHub", desc: "Open source and code", icon: GitHubIcon, href: "https://github.com/itsmawja", handle: "itsmawja" },
  { label: "X", desc: "Follow for updates", icon: XIcon, href: "https://x.com/itsmawja", handle: "@itsmawja" },
  { label: "LinkedIn", desc: "Professional network", icon: LinkedinIcon, href: "https://linkedin.com/in/itsmawja", handle: "@itsmawja" },
  { label: "Instagram", desc: "Music and daily life", icon: InstagramIcon, href: "https://instagram.com/itsmawja", handle: "@itsmawja" },
  { label: "YouTube", desc: "Videos and content", icon: YoutubeIcon, href: "https://youtube.com/@itsmawja", handle: "@itsmawja" },
  { label: "Spotify", desc: "Listen to my music", icon: SIcon, href: "https://open.spotify.com/user/itsmawja", handle: "itsmawja" },
  { label: "Apple Music", desc: "Stream my music", icon: AIcon, href: "https://music.apple.com/profile/itsmawja", handle: "itsmawja" },
  { label: "Email", desc: "Direct contact", icon: Mail, href: "mailto:hello@itsmawja.com", handle: "hello@itsmawja.com", isEmail: true },
];
            ...
            <div className="sticky top-24">
              <div className="mb-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-lg font-bold text-foreground">{t.startConversation}</span>
                </div>
                <p className="text-sm text-foreground/40 leading-relaxed">{t.startConversationDesc}</p>
              </div>
                ...
                {contactLinks.map((l) => {
                  ...
                  return (
                    <a
                      ...
                      rel={!("isEmail" in l) ? "noopener noreferrer" : undefined}
          ...
          <div className="lg:col-span-3">
            <div className="relative rounded-3xl border border-border/20 bg-gradient-to-br from-card/30 via-card/20 to-transparent p-6 sm:p-10 overflow-hidden group hover:border-primary/15 hover:shadow-2xl hover:shadow-primary/[0.03] transition-all duration-700">
              ...
              <div className="relative">
                {msg && (
                  <div className={`mb-8 p-4 rounded-2xl text-sm font-medium ${
                    msg.ok
