...
const streamingPlatforms = [
  { name: "Spotify", icon: SpotifyIcon, url: "https://open.spotify.com/user/itsmawja", color: "#1ED760" },
  { name: "Apple Music", icon: AppleMusicIcon, url: "https://music.apple.com/profile/itsmawja", color: "#FA243C" },
  ...
  { name: "Deezer", icon: DeezerIcon, url: "https://www.deezer.com/us/artist/itsmawja", color: "#A238FF" },
  { name: "Amazon Music", icon: AmazonMusicIcon, url: "https://music.amazon.com/", color: "#46C3D0" },
  { name: "Anghami", icon: AnghamiIcon, url: "https://play.anghami.com/artist/itsmawja", color: "#7200FF" },
  { name: "Bandcamp", icon: BandcampIcon, url: "https://itsmawja.bandcamp.com", color: "#408294" },
  { name: "Tidal", icon: TidalIcon, url: "https://tidal.com/browse/artist/", color: "#000000" },
  { name: "Pandora", icon: PandoraIcon, url: "https://www.pandora.com/", color: "#224099" },
] as const;
