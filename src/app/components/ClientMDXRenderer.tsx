        ...
        <article className="elegant-content">
          <MDXRemote
            ...
            components={{
              ...
              pre: ({ children }) => (
                <pre className="bg-muted/30 p-6 rounded-xl border border-border/50 overflow-x-auto my-8 font-mono text-sm leading-6 shadow-sm">
                  {children}
                </pre>
              ),
              table: ({ children }) => {
              ...
              tr: ({ children }) => (
                <tr className="even:bg-muted/20 border-b border-border">
                  {children}
                </tr>
              ),
              th: ({ children }) => (
              ...
              img: ({ src, alt }) => (
                <img
                  src={src}
                  alt={alt}
                  className="rounded-2xl shadow-lg my-8 mx-auto border border-border/50 max-w-full"
                />
              ),
