  ...
  const playlists: Playlist[] = [
    {
      ...
      title: "CODING FOCUS",
      description:
        "Beautiful instrumental music to keep you in the flow as you code or study. Ideal for programming during stressful times.",
      coverUrl: "/api/placeholder/300/300",
      service: "spotify",
      url: "https://open.spotify.com/playlist/15ngsvOmlTkARCg7ipoNvG",
      embedUrl:
        "https://open.spotify.com/embed/playlist/15ngsvOmlTkARCg7ipoNvG?utm_source=generator",
      trackCount: 1345,
      duration: "over 24 hr",
    },
    {
      ...
      description:
        "Chillstep music perfect for concentration while programming, coding, or hacking. Deep bass, beautiful vocals and rhythms.",
      coverUrl: "/api/placeholder/300/300",
      service: "youtube",
      url: "https://www.youtube.com/watch?v=M5QY2_8704o&list=RDQMzSeUiyuhqBE&start_radio=1",
      embedUrl:
        "https://www.youtube.com/embed/videoseries?list=RDQMzSeUiyuhqBE",
      trackCount: 25,
      duration: "1h 45m",
    },
  ];
  ...
  return (
    <div className="min-h-screen pt-20 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {playlists.length === 0 ? (
            ...
            playlists.map((playlist) => (
              <Card
                key={playlist.id}
                className="group fade-in-up stagger-item"
                padding="sm"
              >
                ...
                <div className="space-y-3">
                  <div className="text-center">
                    ...
                    <div className="flex justify-center items-center gap-2 mb-2">
                      ...
                      <div
                        className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium border ${getServiceColor(playlist.service)}`}
                      >
        ...
        <div className="text-center">
          <Card
            className="bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20 shadow-modern"
            padding="md"
          >
            <div className="p-8">
              ...
              <p className="text-foreground/70 text-base mb-6 max-w-2xl mx-auto">
                Stay updated with my latest releases, playlists, and musical
                experiments across all platforms.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button
                  ...
                  className="flex flex-col items-center justify-center gap-2 min-w-[140px] h-[100px] p-3 glass border-primary/20 hover:border-primary hover:bg-primary/10 text-primary hover:scale-105 transition-all duration-300"
                  onClick={() =>
                    window.open("https://soundcloud.com/bymuja", "_blank")
                  }
                >
                  <div className="w-6 h-6 flex items-center justify-center text-primary">
                    <SoundCloudIcon />
                ...
                <Button
                  ...
                  className="flex flex-col items-center justify-center gap-2 min-w-[140px] h-[100px] p-3 glass border-primary/20 hover:border-primary hover:bg-primary/10 text-primary hover:scale-105 transition-all duration-300"
                  onClick={() =>
                    window.open("https://www.youtube.com/@bymuja", "_blank")
                  }
                >
                  <div className="w-6 h-6 flex items-center justify-center text-primary">
                    <YouTubeIcon />
