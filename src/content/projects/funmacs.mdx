...
githubUrl: "https://github.com/itsmawja/funmacs"
liveUrl: "https://funmacs.itsmawja.com"
featured: true
---
...
<div style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap">
  <img
    src="https://img.shields.io/github/v/release/itsmawja/funmacs?style=flat-square"
    alt="Release"
  />
  <img
    src="https://img.shields.io/github/stars/itsmawja/funmacs?style=flat-square"
    alt="Stars"
  />
  <img
    src="https://img.shields.io/github/forks/itsmawja/funmacs?style=flat-square"
    alt="Forks"
  />
  <img
    src="https://img.shields.io/github/issues/itsmawja/funmacs?style=flat-square"
    alt="Open Issues"
  />
  <img
    src="https://img.shields.io/github/last-commit/itsmawja/funmacs?style=flat-square"
    alt="Last Commit"
  />
</div>
...
<a href="https://github.com/itsmawja/funmacs" target="_blank" style="display:block;position:relative;border-radius:12px;overflow:hidden;border:1px solid var(--color-border);margin:2rem 0">
...
**Buy me a coffee:**  
[![Buy Me A Coffee](https://www.buymeacoffee.com/assets/img/custom_images/purple_img.png)](https://buymeacoffee.com/itsmawja)

**Or become a patron on Patreon:**  
[![Patreon](https://c5.patreon.com/external/logo/become_a_patron_button@2x.png)](https://www.patreon.com/itsmawja)
...
- [**NEOTE**](https://github.com/itsmawja/neote) – Lightweight next-gen text editor.
- [**MujaOS**](https://github.com/itsmawja/mujaos) – Modern and secure operating system.
...
See [LICENSE](https://github.com/itsmawja/funmacs/blob/main/LICENSE) for full details.

---

> 🧩 **FOSS:** [foss.land](https://www.foss.land) &nbsp;•&nbsp;  
> 💻 **GitHub:** [@itsmawja](https://github.com/itsmawja) &nbsp;•&nbsp;  
> 🐦 **Twitter/X:** [@itsmawja](https://x.com/itsmawja)
