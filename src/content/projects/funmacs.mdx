...
githubUrl: "https://github.com/bymuja/funmacs"
liveUrl: "https://funmacs.bymuja.com"
featured: true
---
...
>
  <img
    src="https://img.shields.io/github/v/release/bymuja/funmacs?style=flat-square"
    alt="Release"
  />
  <img
    src="https://img.shields.io/github/stars/bymuja/funmacs?style=flat-square"
    alt="Stars"
  />
  <img
    src="https://img.shields.io/github/forks/bymuja/funmacs?style=flat-square"
    alt="Forks"
  />
  <img
    src="https://img.shields.io/github/issues/bymuja/funmacs?style=flat-square"
    alt="Open Issues"
  />
  <img
    src="https://img.shields.io/github/last-commit/bymuja/funmacs?style=flat-square"
    alt="Last Commit"
  />
</div>
...
```bash
git clone https://github.com/bymuja/funmacs.git ~/.config/emacs
```
...
**Buy me a coffee:**  
[![Buy Me A Coffee](https://www.buymeacoffee.com/assets/img/custom_images/purple_img.png)](https://buymeacoffee.com/bymuja)

**Or become a patron on Patreon:**  
[![Patreon](https://c5.patreon.com/external/logo/become_a_patron_button@2x.png)](https://www.patreon.com/bymuja)
...
- [**NEOTE**](https://github.com/bymuja/neote) – Lightweight next-gen text editor.
- [**MujaOS**](https://github.com/bymuja/mujaos) – Modern and secure operating system.
...
See [LICENSE](https://github.com/bymuja/funmacs/blob/main/LICENSE) for full details.

---

> 🧩 **FOSS:** [foss.land](https://www.foss.land) &nbsp;•&nbsp;  
> 💻 **GitHub:** [@bymuja](https://github.com/bymuja) &nbsp;•&nbsp;  
> 🐦 **Twitter/X:** [@bymuja](https://twitter.com/bymuja)
