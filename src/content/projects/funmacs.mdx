...
githubUrl: "https://github.com/iammawja/funmacs"
liveUrl: "https://funmacs.iammawja.com"
featured: true
---
...
<div style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap">
  <img
    src="https://img.shields.io/github/v/release/iammawja/funmacs?style=flat-square"
    alt="Release"
  />
  <img
    src="https://img.shields.io/github/stars/iammawja/funmacs?style=flat-square"
    alt="Stars"
  />
  <img
    src="https://img.shields.io/github/forks/iammawja/funmacs?style=flat-square"
    alt="Forks"
  />
  <img
    src="https://img.shields.io/github/issues/iammawja/funmacs?style=flat-square"
    alt="Open Issues"
  />
  <img
    src="https://img.shields.io/github/last-commit/iammawja/funmacs?style=flat-square"
    alt="Last Commit"
  />
</div>
...
<a href="https://github.com/iammawja/funmacs" target="_blank" style="display:block;position:relative;border-radius:12px;overflow:hidden;border:1px solid var(--color-border);margin:2rem 0">
...
```bash
git clone https://github.com/iammawja/funmacs.git ~/.config/emacs
```
...
**Buy me a coffee:**  
[![Buy Me A Coffee](https://www.buymeacoffee.com/assets/img/custom_images/purple_img.png)](https://buymeacoffee.com/iammawja)

**Or become a patron on Patreon:**  
[![Patreon](https://c5.patreon.com/external/logo/become_a_patron_button@2x.png)](https://www.patreon.com/iammawja)
...
- [**NEOTE**](https://github.com/iammawja/neote) – Lightweight next-gen text editor.
- [**MujaOS**](https://github.com/iammawja/mujaos) – Modern and secure operating system.
...
See [LICENSE](https://github.com/iammawja/funmacs/blob/main/LICENSE) for full details.

---

> 🧩 **FOSS:** [foss.land](https://www.foss.land) &nbsp;•&nbsp;  
> 💻 **GitHub:** [@iammawja](https://github.com/iammawja) &nbsp;•&nbsp;  
> 🐦 **Twitter/X:** [@iammawja](https://x.com/iammawja)
