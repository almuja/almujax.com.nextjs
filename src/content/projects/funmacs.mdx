...
githubUrl: "https://github.com/almujax/funmacs"
liveUrl: "https://funmacs.almujax.com"
featured: true
---
...
<div style="display: flex; justify-content: center; gap: 8px; flex-wrap: wrap">
  <img
    src="https://img.shields.io/github/v/release/almujax/funmacs?style=flat-square"
    alt="Release"
  />
  <img
    src="https://img.shields.io/github/stars/almujax/funmacs?style=flat-square"
    alt="Stars"
  />
  <img
    src="https://img.shields.io/github/forks/almujax/funmacs?style=flat-square"
    alt="Forks"
  />
  <img
    src="https://img.shields.io/github/issues/almujax/funmacs?style=flat-square"
    alt="Open Issues"
  />
  <img
    src="https://img.shields.io/github/last-commit/almujax/funmacs?style=flat-square"
    alt="Last Commit"
  />
</div>
...
<a href="https://github.com/almujax/funmacs" target="_blank" style="display:block;position:relative;border-radius:12px;overflow:hidden;border:1px solid var(--color-border);margin:2rem 0">
...
```bash
git clone https://github.com/almujax/funmacs.git ~/.config/emacs
```
...
**Buy me a coffee:**  
[![Buy Me A Coffee](https://www.buymeacoffee.com/assets/img/custom_images/purple_img.png)](https://buymeacoffee.com/almujax)

**Or become a patron on Patreon:**  
[![Patreon](https://c5.patreon.com/external/logo/become_a_patron_button@2x.png)](https://www.patreon.com/almujax)
...
- [**NEOTE**](https://github.com/almujax/neote) – Lightweight next-gen text editor.
- [**MujaOS**](https://github.com/almujax/mujaos) – Modern and secure operating system.
...
See [LICENSE](https://github.com/almujax/funmacs/blob/main/LICENSE) for full details.

---

> 🧩 **FOSS:** [foss.land](https://www.foss.land) &nbsp;•&nbsp;  
> 💻 **GitHub:** [@almujax](https://github.com/almujax) &nbsp;•&nbsp;  
> 🐦 **Twitter/X:** [@almujax](https://x.com/almujax)
